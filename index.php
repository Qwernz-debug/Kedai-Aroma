...
<head>
  ...
  <!-- 
    - primary meta tags
  -->
  <title>Kedai Aroma</title>
  <meta name="title" content="Kedai Aroma">
...
<body id="top">
  ...
  <div class="topbar">
    <div class="container">
      ...
      <address class="topbar-item">
        ...
        <span class="span">
          Jalan Basri, Halaman Gedung LVRI, Kota Banjarmasin, Kalimantan Selatan
        </span>
      </address>
      ...
      <div class="topbar-item item-2">
        ...
        <span class="span">Open Tuesday to Sunday :  4.00 pm to 11.00 pm</span>
      </div>

      <a href="tel:+6282253518886" class="topbar-item link">
        <div class="icon">
          <ion-icon name="call-outline" aria-hidden="true"></ion-icon>
        </div>

        <span class="span">+62 822 5351 8886</span>
      </a>
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="./assets/images/logo kedai aromaa.png" width="160" height="50" alt="Grilli - Home">
      </a>
      ...
      <nav class="navbar" data-navbar>
        ...
        <div class="text-center">
          ...
          <address class="body-4">
            Jalan Basri, Halaman Gedung LVRI, <br>
            Kota Banjarmasin, Kalimantan Selatan
          </address>

          <p class="body-4 navbar-text">Open Tuesday to Sunday : 4.00pm - 11.00pm</p>

          <div class="separator"></div>

          <p class="contact-label">Booking Request</p>

          <a href="tel:+6282253518886" class="body-1 contact-number hover-underline">
            +62 822-5351-8886
          </a>
        </div>
          ...
          <div class="form reservation-form bg-black-10">
            ...
            <form action="" class="form-left">
              ...
              <p class="form-text text-center">
                Booking request <a href="tel:+6282253518886" class="link">+62 822 5351 8886</a>
            ...
            <div class="form-right text-center" style="background-image: url('./assets/images/form-pattern.png')">
              ...
              <a href="tel:+6282253518886" class="body-1 contact-number hover-underline">+62 822 5351 8886</a>
    ...
    <div class="container">
      ...
      <div class="footer-top grid-list">
        ...
        <div class="footer-brand has-before has-after">
          ...
          <a href="#" class="logo">
            <img src="./assets/images/logo kedai aromaa.png" width="160" height="50" loading="lazy" alt="grilli home">
          </a>
          ...
          <a href="tel:+6282253518886" class="body-4 contact-link">Booking Request : +62 822 5351 8886</a>
        ...
        <ul class="footer-list">
          ...
          <li>
            <a href="https://www.instagram.com/kedaiaromabjm/" class="label-2 footer-link hover-underline">Instagram</a>
          </li>
          ...
          <li>
            <a href="https://maps.app.goo.gl/B6hCQq45rkVtKQtU9" class="label-2 footer-link hover-underline">Google Map</a>
          </li>
      ...
      <div class="footer-bottom">
        ...
        <p class="copyright">
          &copy; 2024 Kedai Aroma. All Rights Reserved | Crafted by <br><a href="https://www.instagram.com/qwernz__/"
            target="_blank" class="link">Andhi Dwi Lesmana</a>
        </p>
